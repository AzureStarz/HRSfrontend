...
import { Menu, Text, Avatar, Group, UnstyledButton, UnstyledButtonProps, Divider } from '@mantine/core';
import { ChevronRightIcon, ChatBubbleIcon, ExitIcon, PersonIcon, ArchiveIcon } from '@radix-ui/react-icons';
  ...
  ({ image, name, email, icon, ...others }: UserButtonProps, ref) => (
    ...
    >
      <Group>
        ...
        <div style={{ flex: 1 }}>
          <Text color="black" size="sm" weight={450}>
            {name}
          </Text>
  ...
  return (
    <Group position="center">
      <Menu
        ...
        control={
          <UserButton
            image="https://www.h-fureai.com/wp/wp-content/uploads/2019/10/15.png"
            name="Hongbin Zhang"
            email="12345678242@qq.com"
          />
        }
      >
        <Menu.Label>个人中心</Menu.Label>
        <Menu.Item icon={<PersonIcon />}>我的账户</Menu.Item>
        <Menu.Item icon={<ArchiveIcon />}>我的订单</Menu.Item>
        <Menu.Item icon={<ChatBubbleIcon />}>消息</Menu.Item>

        <Divider />
        <Menu.Item color="red" icon={<ExitIcon />}>退出账号</Menu.Item>
      </Menu>
    </Group>
  );
}
          ...
          {inputFocus && (
            <div className="overlay">
              ...
              <div className="field">
                ...
                <input disabled placeholder="Add dates" value={checkInDate.toISOString()}/>
              </div>

              <div className="field">
                <label>Check-out</label>
                <input disabled placeholder="Add dates" value={checkOutDate.toISOString()} />
              </div>
